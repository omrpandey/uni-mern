...
import weddes from '../../assets/images/weddes.jpg';
...
import silverkundan from '../../assets/images/silverkundan.jpg'
...
const Weds = () => {
  ...
  const fetchFilteredAndSortedProducts = async () => {
    try {
      ...
      let apiUrl = `http://localhost:5000/api/product/Weds?`;
  ...
  <img src={weddes} alt="Wedding Banner" className="ws-banner-img" />
</div>
